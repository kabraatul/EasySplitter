...
public class EasySplitter extends JFrame implements ActionListener,ItemListener
{
  ...
  int[] pos={10240,102400,122880,512000,737280,1213952,1457644,103809020,260040850,674758630};
  int attr[]=new int[3];
  ...
  public EasySplitter()
  {
    ...
    JMenuItem win = new JMenuItem("Windows");
 ...
 }   // End of action performend event
 ...
 public int split(String source,String dest,String cmt,int no,int size,int lsize,boolean del,
                                   boolean wipe,boolean batch)
  {
   	...
   	PassDialog dlg = new PassDialog(this,fl.getName());
   	dlg.show();
     ...
     if(temp!=null)
     {
     	...
     	{
     		int ch= temp.charAt(i)-50;
     		pass = pass+(char)ch;
    	}
    }


     String l1=new String("jfs"+","+pass+","+name+","+String.valueOf(fsize)+","+String.valueOf(mtime)+","+String.valueOf(ronly));
   ...
   class PassDialog extends JDialog
   {
   	...
   	String pass="";
   	public PassDialog(JFrame owner, String fn)
   	{
   		super(owner,"Set Password",true);
   		setBounds(200,200,300,150);
   		JPanel center = new JPanel();
   		center.add(new JLabel("Enter the password for "+fn+":"));
   ...
   public int merge(String split,String dest,boolean del)
   {
     try
     {
       ...
       String pass="";
       PassDialog dlg = new PassDialog(this,"");
       if(!temp.equals("null"))
       {
       		for(int i=0;i<temp.length();i++)
       		{
    	...
    	pass="null";
       	if(pass.equals(dlg.pass)||pass.equals("null"))
       	{
       	...
       	{
       		JOptionPane.showMessageDialog(null,"Invalid Password, File can not be mergerd","ERROR",3);
       		return 0;
       	}
  ...
  class about extends javax.swing.JFrame
   {
     ...
     about()
     {
       super("About EasySplitter 1.1.0");
       la1=new JLabel("Name       : EasySplitter(File Splitter)");
       la2=new JLabel("Version    : 1.1.0");
       la3=new JLabel("Developed by : Sagar Patil ,  Jayesh Chavhan");
       la4=new JLabel("  Sunil More, Rakesh Mahajan");
       la5=new JLabel("  Government Polytechnic, Jalgaon, India ");
       img=new JLabel(new ImageIcon("images/img.jpg"));
       ta=new JTextArea(5,30);
       ta.setText(" If any doubts, please feel free to mail to:\n"+
       				"jayeshchavhan@yahoo.com\nsagarpatil@rediffmail.com");
